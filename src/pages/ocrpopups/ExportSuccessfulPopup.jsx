...
const ExportSuccessfulPopup = ({ closePopup }) => {
    return (
        <div className="w-[90%] max-w-[540px] rounded-[40px] 
            ...
            {/* Button */}
            <button className="font-avenir font-bold text-[18px] sm:text-[20px] leading-[100%] 
                               text-[#FDFDFD] bg-[#21527D] rounded-[10px]
                               w-[150px] sm:w-[165px] h-[45px] sm:h-[50px]">
                Extract
            </button>
        </div>
    );
